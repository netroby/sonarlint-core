...
public class SonarLintTelemetryTest {
  ...
  @Test
  public void analysisDoneOnMultipleFiles_should_trigger_analysisDone_when_enabled() {
    when(engine.isEnabled()).thenReturn(true);
  ...
  @Test
  public void analysisDoneOnMultipleFiles_should_not_trigger_usedAnalysis_when_disabled() {
    when(engine.isEnabled()).thenReturn(false);
    telemetry.analysisDoneOnMultipleFiles();
    verify(engine).isEnabled();
    verifyNoMoreInteractions(engine);
  ...
  @Test
  public void analysisDoneOnSingleFile_should_trigger_analysisDone_when_enabled() {
    when(engine.isEnabled()).thenReturn(true);
  ...
  @Test
  public void analysisDoneOnSingleFile_should_not_trigger_usedAnalysis_when_disabled() {
    when(engine.isEnabled()).thenReturn(false);
    telemetry.analysisDoneOnSingleFile("java", 1000);
    verify(engine).isEnabled();
    verifyNoMoreInteractions(engine);
